...
static inline pdu_channel_control canzero_get_lp_channel11_control() {
  extern pdu_channel_control __oe_lp_channel11_control;
  return __oe_lp_channel11_control;
}
static inline pdu_channel_status canzero_get_lp_channel11_status() {
  extern pdu_channel_status __oe_lp_channel11_status;
  return __oe_lp_channel11_status;
}
static inline float canzero_get_lp_channel11_current() {
  extern float __oe_lp_channel11_current;
  return __oe_lp_channel11_current;
}
static inline pdu_channel_control canzero_get_lp_channel12_control() {
  extern pdu_channel_control __oe_lp_channel12_control;
  return __oe_lp_channel12_control;
}
static inline pdu_channel_status canzero_get_lp_channel12_status() {
  extern pdu_channel_status __oe_lp_channel12_status;
  return __oe_lp_channel12_status;
}
static inline float canzero_get_lp_channel12_current() {
  extern float __oe_lp_channel12_current;
  return __oe_lp_channel12_current;
}
static inline pdu_channel_control canzero_get_lp_channel13_control() {
  extern pdu_channel_control __oe_lp_channel13_control;
  return __oe_lp_channel13_control;
}
static inline pdu_channel_status canzero_get_lp_channel13_status() {
  extern pdu_channel_status __oe_lp_channel13_status;
  return __oe_lp_channel13_status;
}
static inline float canzero_get_lp_channel13_current() {
  extern float __oe_lp_channel13_current;
  return __oe_lp_channel13_current;
}
static inline pdu_channel_control canzero_get_lp_channel14_control() {
  extern pdu_channel_control __oe_lp_channel14_control;
  return __oe_lp_channel14_control;
}
static inline pdu_channel_status canzero_get_lp_channel14_status() {
  extern pdu_channel_status __oe_lp_channel14_status;
  return __oe_lp_channel14_status;
}
static inline float canzero_get_lp_channel14_current() {
  extern float __oe_lp_channel14_current;
  return __oe_lp_channel14_current;
}
...
} canzero_message_pdu12_stream_channel_currents_1;
static const uint32_t canzero_message_pdu12_stream_channel_currents_1_id = 0x5C;
typedef struct {
  float lp_channel9_current;
  float lp_channel10_current;
  float lp_channel11_current;
  float lp_channel12_current;
  float lp_channel13_current;
  float lp_channel14_current;
} canzero_message_pdu12_stream_channel_currents_2;
static const uint32_t canzero_message_pdu12_stream_channel_currents_2_id = 0x7C;
typedef struct {
  float total_current;
...
typedef struct {
  ...
  pdu_channel_status lp_channel12_status;
  pdu_channel_status lp_channel13_status;
  pdu_channel_status lp_channel14_status;
...
typedef struct {
  ...
  pdu_channel_control pdu12_lp_channel13_control;
  pdu_channel_control pdu12_lp_channel14_control;
...
static void canzero_serialize_canzero_message_pdu12_stream_channel_currents_1(canzero_message_pdu12_stream_channel_currents_1* msg, canzero_frame* frame) {
  uint8_t* data = frame->data;
  frame->id = 0x5C;
  frame->dlc = 8;
...
static void canzero_serialize_canzero_message_pdu12_stream_channel_currents_2(canzero_message_pdu12_stream_channel_currents_2* msg, canzero_frame* frame) {
  uint8_t* data = frame->data;
  frame->id = 0x7C;
  frame->dlc = 6;
  ...
  float lp_channel11_current_16 = (msg->lp_channel11_current - 0) / 0.011764705882352941;
  if (lp_channel11_current_16 > 4278190080.000) {
    lp_channel11_current_16 = 4278190080.000;
  }
  ((uint32_t*)data)[0] |= (uint32_t) lp_channel11_current_16 << 16;
  float lp_channel12_current_24 = (msg->lp_channel12_current - 0) / 0.011764705882352941;
  if (lp_channel12_current_24 > 4278190080.000) {
    lp_channel12_current_24 = 4278190080.000;
  }
  ((uint32_t*)data)[0] |= (uint32_t) lp_channel12_current_24 << 24;
  float lp_channel13_current_32 = (msg->lp_channel13_current - 0) / 0.011764705882352941;
  if (lp_channel13_current_32 > 4278190080.000) {
    lp_channel13_current_32 = 4278190080.000;
  }
  ((uint32_t*)data)[1] = (uint32_t) lp_channel13_current_32;
  float lp_channel14_current_40 = (msg->lp_channel14_current - 0) / 0.011764705882352941;
  if (lp_channel14_current_40 > 4278190080.000) {
    lp_channel14_current_40 = 4278190080.000;
  }
  ((uint32_t*)data)[1] |= (uint32_t) lp_channel14_current_40 << 8;
}
...
static void canzero_serialize_canzero_message_pdu12_stream_channel_status(canzero_message_pdu12_stream_channel_status* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] |= (uint8_t)(msg->lp_channel12_status & (0xFF >> (8 - 2))) << 22;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->lp_channel13_status & (0xFF >> (8 - 2))) << 24;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->lp_channel14_status & (0xFF >> (8 - 2))) << 26;
...
static void canzero_serialize_canzero_message_master_stream_pdu12_control(canzero_message_master_stream_pdu12_control* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] |= (uint8_t)(msg->pdu12_lp_channel13_control & (0xFF >> (8 - 1))) << 12;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->pdu12_lp_channel14_control & (0xFF >> (8 - 1))) << 13;
}
...
static void canzero_deserialize_canzero_message_pdu12_stream_channel_currents_1(canzero_frame* frame, canzero_message_pdu12_stream_channel_currents_1* msg) {
  uint8_t* data = frame->data;
...
static void canzero_deserialize_canzero_message_pdu12_stream_channel_currents_2(canzero_frame* frame, canzero_message_pdu12_stream_channel_currents_2* msg) {
  uint8_t* data = frame->data;
  ...
  msg->lp_channel11_current = ((((uint32_t*)data)[0] >> 16) & (0xFFFFFFFF >> (32 - 8))) * 0.011764705882352941 + 0;
  msg->lp_channel12_current = ((((uint32_t*)data)[0] >> 24) & (0xFFFFFFFF >> (32 - 8))) * 0.011764705882352941 + 0;
  msg->lp_channel13_current = (((uint32_t*)data)[1] & (0xFFFFFFFF >> (32 - 8))) * 0.011764705882352941 + 0;
  msg->lp_channel14_current = ((((uint32_t*)data)[1] >> 8) & (0xFFFFFFFF >> (32 - 8))) * 0.011764705882352941 + 0;
}
...
static void canzero_deserialize_canzero_message_pdu12_stream_channel_status(canzero_frame* frame, canzero_message_pdu12_stream_channel_status* msg) {
  ...
  msg->lp_channel12_status = (pdu_channel_status)((((uint32_t*)data)[0] >> 22) & (0xFFFFFFFF >> (32 - 2)));
  msg->lp_channel13_status = (pdu_channel_status)((((uint32_t*)data)[0] >> 24) & (0xFFFFFFFF >> (32 - 2)));
  msg->lp_channel14_status = (pdu_channel_status)((((uint32_t*)data)[0] >> 26) & (0xFFFFFFFF >> (32 - 2)));
...
static void canzero_deserialize_canzero_message_master_stream_pdu12_control(canzero_frame* frame, canzero_message_master_stream_pdu12_control* msg) {
  ...
  msg->pdu12_lp_channel13_control = (pdu_channel_control)((((uint32_t*)data)[0] >> 12) & (0xFFFFFFFF >> (32 - 1)));
  msg->pdu12_lp_channel14_control = (pdu_channel_control)((((uint32_t*)data)[0] >> 13) & (0xFFFFFFFF >> (32 - 1)));
}
...
static inline void canzero_set_lp_channel11_control(pdu_channel_control value){
  extern pdu_channel_control __oe_lp_channel11_control;
  __oe_lp_channel11_control = value;
}
void canzero_set_lp_channel11_status(pdu_channel_status value);
static inline void canzero_set_lp_channel11_current(float value){
  extern float __oe_lp_channel11_current;
  __oe_lp_channel11_current = value;
}
static inline void canzero_set_lp_channel12_control(pdu_channel_control value){
  extern pdu_channel_control __oe_lp_channel12_control;
  __oe_lp_channel12_control = value;
}
void canzero_set_lp_channel12_status(pdu_channel_status value);
static inline void canzero_set_lp_channel12_current(float value){
  extern float __oe_lp_channel12_current;
  __oe_lp_channel12_current = value;
}
static inline void canzero_set_lp_channel13_control(pdu_channel_control value){
  extern pdu_channel_control __oe_lp_channel13_control;
  __oe_lp_channel13_control = value;
}
void canzero_set_lp_channel13_status(pdu_channel_status value);
static inline void canzero_set_lp_channel13_current(float value){
  extern float __oe_lp_channel13_current;
  __oe_lp_channel13_current = value;
}
static inline void canzero_set_lp_channel14_control(pdu_channel_control value){
  extern pdu_channel_control __oe_lp_channel14_control;
  __oe_lp_channel14_control = value;
}
void canzero_set_lp_channel14_status(pdu_channel_status value);
static inline void canzero_set_lp_channel14_current(float value){
  extern float __oe_lp_channel14_current;
  __oe_lp_channel14_current = value;
}
