...
static const uint32_t canzero_message_power_board12_stream_state_id = 0x63;
typedef struct {
  float m_mcu_temperature;
} canzero_message_power_board12_stream_temperature;
static const uint32_t canzero_message_power_board12_stream_temperature_id = 0x6B;
typedef struct {
  error_flag m_assertion_fault;
  error_level m_error_level_mcu_temperature;
} canzero_message_power_board12_stream_errors;
static const uint32_t canzero_message_power_board12_stream_errors_id = 0x4B;
typedef struct {
...
static const uint32_t canzero_message_power_board12_stream_channel_status_id = 0x6C;
typedef struct {
...
static const uint32_t canzero_message_power_board12_stream_channel_currents1_id = 0x6D;
typedef struct {
...
static const uint32_t canzero_message_power_board12_stream_channel_currents2_id = 0x4C;
typedef struct {
  node_id m_node_id;
